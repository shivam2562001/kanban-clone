...
function index({showSideBar, setShowSideBar}) {
  ...
  return (
    <div className={`sidebar-conatiner md:w-2/12 md:flex md:flex-col md:relative h-[100vh] fixed md:z-0 z-30  md:border-r-2 md:transform-none transition-all duration-200 delay-200 ease-out ${showSideBar ? "" :"-translate-x-full"}`}>
      ...
      <div className="flex flex-col justify-center  gap-y-4 sidebar-list-section px-3 py-7 pl-4 pr-4">
        {/*  //list-item */}
      ...
      <div className="flex flex-col  sidebar-list-section p-4">
        <div className="flex flex-row justify-between ">
          <div className="section-header uppercase">my projects</div>
        ...
        <div className="flex flex-col gap-y-1 mt-3">
          <CustomTile color="green" title="Mobile App" isSelected={true} />
          <CustomTile color="orange" title="Website Redesign" />
          <CustomTile color="gray" title="Design System" />
          <CustomTile color="blue" title="Wireframes" />
        </div>
      </div>
      <div className="mt-5 pl-4 pr-4 mb-5">
        <NoteViewContainer title={"Thoughts Time"}>
